...
footer = tk.Label(sidebar, text="© 2025 BUBT Fantastic5 All Rights Reserved", bg="#0b4d2e", fg="#a6d1c0", font=small_font)
...
# Profile card
profile_card = tk.Frame(content, bg="white", bd=1, relief="solid")
profile_card.pack(fill="x", padx=10, pady=10)
profile_card.pack_propagate(False)
profile_card.configure(height=80)
...
name_label = tk.Label(left_profile, text="John Doe", bg="white", font=big_font)
role_label = tk.Label(left_profile, text="LECTURER", bg="white", fg="#6c757d", font=small_font)
...
# place cards horizontally with spacing
for t, v, c in stats:
